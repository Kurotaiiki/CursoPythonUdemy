...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_4.clicked.connect(self.generarPdf)
    ...
    def dibujarTabla(self):
        #Adaptar la longitud de lla tabla horizontalmente
    ...
    def generarPdf(self):
        ...
        try:
            ...
            pdfkit.from_file(absPath('reporte.html'),absPath('reporte.pdf'),options=option)
        except Exception as e:
